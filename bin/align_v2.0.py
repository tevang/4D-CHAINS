...
from lib.connectivities.__init__ import Connectivities
...
-rstfile results_summary.6mers_round1""")
    ...
    parser.add_argument("-aln_shift", dest="SPECTRUM_COMBO", required=False, type=int, default=0,
                        help="control the shift of the aligned peptides. E.g. in TOCSY-HCNH we had a shift of -1, but in "
                        "NOESY we have shift 0. Default: %(default)s",
                        metavar="<alignment shift>")
...
if __name__ == "__main__":
    ...
    try:
        ...
        write_overlapped_chains_alignment(template_sequence_alignment_string,
                                          args.consensus_alignment_file,
                                          args.chars_per_line,
                                          1)
        ...
        write_consensus_alignment(iter2_ordered_consensus_peptide_alignment_list,
                                  iter2_ordered_consensus_chain_alignment_list,
                                  iter2_ordered_consensus_TAAIGScore_alignment_list,
                                  template_sequence_alignment_string,
                                  args.consensus_alignment_file,
        ...
        iter2_refchain_overlappingChainsList_dict, \
        iter2_all_overlapped_chain_alignments_list = \
            create_overlapped_chain_alignments(iter2_ordered_consensus_peptide_alignment_list,
                                               iter2_ordered_consensus_chain_alignment_list,
                                               OVERLAP_CUTOFF=args.OVERLAP_CUTOFF)
        ...
        #                    iter2_ordered_consensus_peptide_alignment_list, iter2_ordered_consensus_chain_alignment_list, iter2_ordered_consensus_TAAIGScore_alignment_list, iter2_position_TAAIG_confidenceScore_mdict, SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        #
        ...
        iter3_ordered_consensus_TAAIGScore_alignment_list, \
        iter3tmp_position_TAAIG_confidenceScore_mdict, \
        consensus_absolute_matches_alignment = \
            filter_alignments_using_absolute_matches(iter2_absolute_matches_alignment,
                                                     iter2_ordered_consensus_peptide_alignment_list,
                                                     iter2_ordered_consensus_chain_alignment_list,
                                                     iter2_ordered_consensus_TAAIGScore_alignment_list,
                                                     iter2_position_TAAIG_confidenceScore_mdict,
                                                     SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        
        del iter2_ordered_consensus_peptide_alignment_list, iter2_ordered_consensus_chain_alignment_list, iter2_ordered_consensus_TAAIGScore_alignment_list
        #print "DEBUG: iter2_ordered_consensus_chain_alignment_list=", iter2_ordered_consensus_chain_alignment_list
        write_consensus_alignment(iter3_ordered_consensus_peptide_alignment_list,
                                  iter3_ordered_consensus_chain_alignment_list,
                                  iter3_ordered_consensus_TAAIGScore_alignment_list,
                                  template_sequence_alignment_string,
                                  args.consensus_alignment_file,
        ...
        iter3_refchain_overlappingChainsList_dict, \
        iter3_all_overlapped_chain_alignments_list = \
            create_overlapped_chain_alignments(iter3_ordered_consensus_peptide_alignment_list,
                                               iter3_ordered_consensus_chain_alignment_list,
                                               OVERLAP_CUTOFF=args.OVERLAP_CUTOFF)
        ...
        #### 4th ITERATION
        iter4_ordered_consensus_peptide_alignment_list, \
        iter4_ordered_consensus_chain_alignment_list, \
        iter4_ordered_consensus_TAAIGScore_alignment_list, \
        iter4tmp_position_TAAIG_confidenceScore_mdict, \
        consensus_absolute_matches_alignment = \
            filter_alignments_using_absolute_matches(iter3_absolute_matches_alignment,
                                                     iter3_ordered_consensus_peptide_alignment_list,
                                                     iter3_ordered_consensus_chain_alignment_list,
                                                     iter3_ordered_consensus_TAAIGScore_alignment_list,
                                                     iter3_position_TAAIG_confidenceScore_mdict,
                                                     SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        ...
        #print "DEBUG: iter3_ordered_consensus_chain_alignment_list=", iter3_ordered_consensus_chain_alignment_list
        write_consensus_alignment(iter4_ordered_consensus_peptide_alignment_list,
                                  iter4_ordered_consensus_chain_alignment_list,
                                  iter4_ordered_consensus_TAAIGScore_alignment_list,
                                  template_sequence_alignment_string,
                                  args.consensus_alignment_file,
        ...
        iter4_refchain_overlappingChainsList_dict, \
        iter4_all_overlapped_chain_alignments_list = \
            create_overlapped_chain_alignments(iter4_ordered_consensus_peptide_alignment_list,
                                               iter4_ordered_consensus_chain_alignment_list,
                                               OVERLAP_CUTOFF=args.OVERLAP_CUTOFF)
        ...
        iter5_ordered_consensus_chain_alignment_list, \
        iter5_ordered_consensus_TAAIGScore_alignment_list, \
        iter5tmp_position_TAAIG_confidenceScore_mdict, \
        consensus_absolute_matches_alignment = \
            filter_alignments_using_absolute_matches(iter4_absolute_matches_alignment,
                                                     iter4_ordered_consensus_peptide_alignment_list,
                                                     iter4_ordered_consensus_chain_alignment_list,
                                                     iter4_ordered_consensus_TAAIGScore_alignment_list,
                                                     iter4_position_TAAIG_confidenceScore_mdict,
                                                     SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        ...
        write_consensus_alignment(iter5_ordered_consensus_peptide_alignment_list,
                                  iter5_ordered_consensus_chain_alignment_list,
                                  iter5_ordered_consensus_TAAIGScore_alignment_list,
                                  template_sequence_alignment_string,
                                  args.consensus_alignment_file,
        ...
        iter5_refchain_overlappingChainsList_dict, \
        iter5_all_overlapped_chain_alignments_list = \
            create_overlapped_chain_alignments(iter5_ordered_consensus_peptide_alignment_list,
                                               iter5_ordered_consensus_chain_alignment_list,
                                               OVERLAP_CUTOFF=args.OVERLAP_CUTOFF)
        ...
        ## 6th ITERATION
        iter6_ordered_consensus_peptide_alignment_list, \
        iter6_ordered_consensus_chain_alignment_list, \
        iter6_ordered_consensus_TAAIGScore_alignment_list, \
        iter6tmp_position_TAAIG_confidenceScore_mdict, \
        consensus_absolute_matches_alignment = \
            filter_alignments_using_absolute_matches(iter5_absolute_matches_alignment,
                                                     iter5_ordered_consensus_peptide_alignment_list,
                                                     iter5_ordered_consensus_chain_alignment_list,
                                                     iter5_ordered_consensus_TAAIGScore_alignment_list,
                                                     iter5_position_TAAIG_confidenceScore_mdict,
                                                     SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        ...
        write_consensus_alignment(iter6_ordered_consensus_peptide_alignment_list,
                                  iter6_ordered_consensus_chain_alignment_list,
                                  iter6_ordered_consensus_TAAIGScore_alignment_list,
                                  template_sequence_alignment_string,
                                  args.consensus_alignment_file,
        ...
        iter6_refchain_overlappingChainsList_dict, \
        iter6_all_overlapped_chain_alignments_list = \
            create_overlapped_chain_alignments(iter6_ordered_consensus_peptide_alignment_list,
                                               iter6_ordered_consensus_chain_alignment_list,
                                               OVERLAP_CUTOFF=args.OVERLAP_CUTOFF)
        ...
        ## 7th ITERATION
        iter7_ordered_consensus_peptide_alignment_list, \
        iter7_ordered_consensus_chain_alignment_list, \
        iter7_ordered_consensus_TAAIGScore_alignment_list, \
        iter7tmp_position_TAAIG_confidenceScore_mdict, \
        consensus_absolute_matches_alignment = \
            filter_alignments_using_absolute_matches(iter6_absolute_matches_alignment,
                                                     iter6_ordered_consensus_peptide_alignment_list,
                                                     iter6_ordered_consensus_chain_alignment_list,
                                                     iter6_ordered_consensus_TAAIGScore_alignment_list,
                                                     iter6_position_TAAIG_confidenceScore_mdict,
                                                     SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        ...
        write_consensus_alignment(iter7_ordered_consensus_peptide_alignment_list,
                                  iter7_ordered_consensus_chain_alignment_list,
                                  iter7_ordered_consensus_TAAIGScore_alignment_list,
                                  template_sequence_alignment_string,
                                  args.consensus_alignment_file,
        ...
        iter7_refchain_overlappingChainsList_dict, \
        iter7_all_overlapped_chain_alignments_list = \
            create_overlapped_chain_alignments(iter7_ordered_consensus_peptide_alignment_list,
                                               iter7_ordered_consensus_chain_alignment_list,
                                               OVERLAP_CUTOFF=args.OVERLAP_CUTOFF)
        ...
        final_ordered_consensus_peptide_alignment_list, \
        final_ordered_consensus_chain_alignment_list, \
        final_ordered_consensus_TAAIGScore_alignment_list, \
        ...
        consensus_absolute_matches_alignment = \
            filter_alignments_using_absolute_matches(iter7_absolute_matches_alignment,
                                                     ...
                                                     iter7_ordered_consensus_chain_alignment_list,
                                                     iter7_ordered_consensus_TAAIGScore_alignment_list,
                                                     iter7_position_TAAIG_confidenceScore_mdict,
                                                     SPECTRUM_COMBO=args.SPECTRUM_COMBO)
        ...
        save_pickle("print_results_summary_input.pkl",
                      template_sequence_alignment_string,
                      consensus_absolute_matches_alignment,
                      final_position_TAAIG_confidenceScore_mdict,
                      final_ordered_consensus_chain_alignment_list,
        ...
        print_results_summary(template_sequence_alignment_string, consensus_absolute_matches_alignment,
                              final_position_TAAIG_confidenceScore_mdict,
                              final_ordered_consensus_chain_alignment_list, i_iminus1_dict,
                              SPECTRUM_COMBO=args.SPECTRUM_COMBO)
